                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div
                            ...
                            <div class="card-body">
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            ...
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->max_users  == '-1' ? 'Lifetime' : $value->max_users }}
                                                User</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox"
                                                id="customCheckc1" {{ $value->max_customers != 0 ? 'checked' : '' }}>
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->max_customers  == '-1' ? 'Lifetime' : $value->max_customers }}
                                                Customer</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox"
                                                id="customCheckc1" {{ $value->max_venders != 0 ? 'checked' : '' }}>
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->max_venders  == '-1' ? 'Lifetime' : $value->max_venders }}
                                                Vendors</label>
                                        </div>
                                    </li>
                                    <li>
                                ...
                                <div class="d-grid">
                                    <a href="{{ route('register') }}" class="btn btn-primary rounded-pill">Start
                                        with
