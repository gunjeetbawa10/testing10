                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    {{ Form::textarea('topbar_notification_msg',$settings['topbar_notification_msg'], ['class' => ' form-control', 'required' => 'required', 'id'=>'mytextarea']) }}
                                    {{-- {!! Form::textarea('topbar_notification_msg', $settings['topbar_notification_msg'], [
                                        'class' => 'form-control',
                                        'rows' => '5',
                                        'id' => 'mytextarea',
                                    ]) !!} --}}
